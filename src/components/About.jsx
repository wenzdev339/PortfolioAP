        ...
        <div className="about-content">
          <div className="about-text">
            <p className="animate-in" style={{ animationDelay: '0.4s' }}>
              My name is Anatcha Pankean (Owen), a Computer Engineering graduate from Naresuan University. I'm a Full Stack Developer with strong interests in Business Analysis, Business Intelligence, and Data-driven solutions. I combine technical expertise with business insight to build solutions that deliver both functionality and strategic value.
            </p>
          </div>
        </div>
      </div>
